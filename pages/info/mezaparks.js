...
export default function Home() {
  const description_lv = lv_data['info_izstade']?.description;
  const description_en = en_data['info_izstade']?.description;
  const name_lv = lv_data['info_izstade']?.name;
  const name_en = en_data['info_izstade']?.name;
